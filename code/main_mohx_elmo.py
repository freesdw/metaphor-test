...
from model_rnn_hg import RNNSequenceModel, ExpModel, ParaEncoder, LinearFC, ModelSet, AttenLoss
...
for i in range(10):
    ...
    Exp_model = ExpModel(embedding_dim=1024, hidden_size=256,
                                    num_layers=1, bidir=True,
                                    dropout1=0.5)
    Query_model = ExpModel(embedding_dim=1024, hidden_size=256,
                                    num_layers=1, bidir=True,
                                    dropout1=0.5)
    ...
    para_encoder = ParaEncoder(embedding_dim=1024, hidden_size=256,
    ...
    for epoch in range(num_epochs):
        ...
        for (example_pos, example_text, example_lengths, labels, para_idx, paraset, paraset_attn, paraset_len_mask) in train_dataloader_mohx:
            ...
            attn_weight = Variable(attn_weight,requires_grad=True)
            ...
            #     print("Iteration {}. Training Loss {}. Atten {}.".format(num_iter, avg_eval_loss, attn_acc))
